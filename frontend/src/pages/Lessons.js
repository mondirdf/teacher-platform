...
import { BookOpen, Play, FileText, Filter, Search, ArrowLeft, ArrowRight } from 'lucide-react';
...
const Lessons = () => {
  ...
  const fetchLessons = async () => {
    try {
      ...
      const { data: lessonsData, error, count } = await query;
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 mb-4">مكتبة الدروس</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            اكتشف مجموعة متنوعة من الدروس التعليمية المصممة خصيصاً لتطوير مهاراتك
          </p>
        </motion.div>
          ...
          <>
            {lessons.length > 0 ? (
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center space-x-2 text-gray-500 text-sm">
                          <div className="flex items-center">
                            ...
                            <span>{lesson.video_count || 0}</span>
                          </div>
                          <div className="flex items-center">
                            <FileText className="w-4 h-4 ml-1" />
                            <span>{lesson.file_count || 0}</span>
                          </div>
                        </div>
                      </div>
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500">لم يتم العثور على دروس مطابقة لبحثك</p>
              </div>
            )}
